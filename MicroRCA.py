    ...
    for folder in folders:
        for fault_type in faults_type:
            for target in targets:
                ...
                # prefix of csv files 
                faults_name = '/Users/zhangkaiqi/PycharmProjects/MicroRCA-master/rootcausemetrics-master/1_Original_data/data/service/' + folder + '/' + fault_type + '_' + target
                ...
                with open(filename, 'a') as f:
                    writer = csv.writer(f)
                    writer.writerow(["folder:"+folder, target, fault_type, num, anomaly_score_new[:num], anomaly_nodes])
